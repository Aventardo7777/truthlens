...
def full_scan_payload(df: pd.DataFrame, filename: str = "upload") -> dict:
    """Run the scan and return a fully JSON-serializable payload."""
    result = run_full_scan(df, filename)
